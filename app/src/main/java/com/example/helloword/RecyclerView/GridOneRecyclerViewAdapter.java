...
public class GridOneRecyclerViewAdapter extends RecyclerView.Adapter<GridOneRecyclerViewAdapter.LinearViewHolder> {

    private Context mContext;
    private List list;

    public GridOneRecyclerViewAdapter(Context context){
        this.mContext = context;
    }
    @NonNull
    @Override
    public GridOneRecyclerViewAdapter.LinearViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GridOneRecyclerViewAdapter.LinearViewHolder holder, final int position) {
