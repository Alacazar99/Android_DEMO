...
public class HorRecyclerAdapter extends RecyclerView.Adapter<HorRecyclerAdapter.LinearViewHolder> {

    private Context mContext;
    private List list;

    public HorRecyclerAdapter(Context context){
        this.mContext = context;
    }
    @NonNull
    @Override
    public HorRecyclerAdapter.LinearViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HorRecyclerAdapter.LinearViewHolder holder, final int position) {
